        ...
        static const unsigned char kTritonCubin_rope_mrope_fwd_yarnon_fp32_sm80[] = {
            0x7f, 0x45, 0x4c, 0x46, 0x02, 0x01, 0x01, 0x33, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00
        };
        static const size_t kTritonCubinSize_rope_mrope_fwd_yarnon_fp32_sm80 = sizeof(kTritonCubin_rope_mrope_fwd_yarnon_fp32_sm80);

        static const char kTritonKernelName_rope_mrope_fwd_yarnon_fp32_sm80[] = "rope_kernel_fp32";
        static const int  kTritonBlockSize_rope_mrope_fwd_yarnon_fp32_sm80    = 128;
        ...
        static int load_module_once(void) {
            ...
            CUresult r = cuModuleLoadData(&g_module, kTritonCubin_rope_mrope_fwd_yarnon_fp32_sm80);
            if (r != CUDA_SUCCESS) { g_load_failed = 1; return -1; }
            r = cuModuleGetFunction(&g_function, g_module, kTritonKernelName_rope_mrope_fwd_yarnon_fp32_sm80);
            if (r != CUDA_SUCCESS) { g_load_failed = 1; return -1; }
            return 0;
        }
...
int32_t     rows) {
            ...
            (void) kTritonCubinSize_rope_mrope_fwd_yarnon_fp32_sm80;
        }
